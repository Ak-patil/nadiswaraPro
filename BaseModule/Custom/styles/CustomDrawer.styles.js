...
export const styles = StyleSheet.create({
    ...
    headerEmail: { fontSize: moderateScale(16), color: 'lightgray' },
    drawerContent: { fontSize: moderateScale(18), fontWeight: 'bold' },
    signOutButton: {
        paddingHorizontal: horizontalScale(15),
    ...
    signOutText: { color: '#2E86C1', fontSize: moderateScale(18) },
    drawerCloseButton: {
        position: 'absolute',
        right: width * 0.13,
